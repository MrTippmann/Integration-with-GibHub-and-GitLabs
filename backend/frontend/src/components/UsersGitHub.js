...
import "../App.css";
import UserDetailsGitHub from "./UserDetailsGitHub";
import { Button } from './Button';

// Component that fetches the list of cars
class UsersGitHub extends React.Component {
  // Constructor
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <>
        ...
        <Button onClick={this.onButtonClick}>GitHub user | Name: {userData.name}</Button>
        {this.state.showComponent ?
           <UserDetailsGitHub username={userData.login} /> :
           null
        }
        </div>
      </>
